...
Servo myservo3;
Servo myservo4;
int pos1=90, pos2=90, pos3=90, pos4=45;  // define the variable of 4 servo angle and assign the initial value( that is the boot posture angle value)
char val;
...
void loop() 
{
  ...
  myservo3.attach(11);   // set the control pin of servo 3 to D6
