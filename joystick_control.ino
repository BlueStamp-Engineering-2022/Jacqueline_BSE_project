...
Servo myservo3;
Servo myservo4;
int pos1=90, pos2=90, pos3=45, pos4=45; // define the variable of 4 servo angle,and assign the initial value (that is the boot posture
//angle value)
...
void loop()
{
  ...
  myservo3.attach(11); //set the control pin of servo 3 to D6   lower arm-servo-6
...
if(pos4<0) // 
{
pos4=0; //limit the largest angle when close the claw
}
...
delay(5);
if(pos3<30) //  limit the angle when go down 
{
pos3=30;
} 
}
...
if(pos3>180) //limit the lifting angle 
{
pos3=180; 
} 
